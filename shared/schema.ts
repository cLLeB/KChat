...
export const chatRooms = pgTable("chat_rooms", {
  ...
  // Default TTL (in seconds) for messages created in this room. Nullable — if not set,
  // server logic will fall back to reasonable defaults per message type.
  defaultMessageTTLSeconds: integer("default_message_ttl_seconds").default(600),
});
